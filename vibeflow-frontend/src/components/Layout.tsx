      ...
      <header className="relative bg-white/90 backdrop-blur-sm shadow-2xl border-b-4 border-transparent z-10">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <nav className="flex items-center space-x-2"> {/* Adjusted space-x for potentially more items */}
              <button
                onClick={() => onNavigate("/about")}
                className="px-5 py-3 text-sm font-semibold text-gray-700 hover:text-brand-primary transition-colors duration-300 rounded-full hover:bg-gray-100"
              >
                About
              </button>
              <button
